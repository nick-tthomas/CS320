...
public class ContactServiceTest {
  ...
  @BeforeEach
  void setUp() {
    contactId = "2019Z022A5";
    firstNameTest = "Nick";
    lastNameTest = "Thomas";
    phoneNumberTest = "0123456789";
    addressTest = "4719 E 6th Ave Spokane Valley";
    tooLongContactId = "01123581321345589144";
    tooLongFirstName = "Nicholas Todd Thomas";			
    tooLongLastName = "This last name is too long";
    tooLongPhoneNumber = "01234567890123456789";
    tooShortPhoneNumber = "01234";
    tooLongAddress = "4719 E 6th Ave Spokane Valley, WA 99212";
  }
